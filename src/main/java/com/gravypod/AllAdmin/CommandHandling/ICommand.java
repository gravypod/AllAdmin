...
public abstract interface ICommand {
	...
	/**
	 * 
	 * Used to register a command on startup. Should only called one time!
	 * 
	 * @param plugin
	 *            - Instance of the plugin for it to be registered to.
	 * @param commandHandler
	 *            - CommandHandler to pass itself to
	 * 
	 */
